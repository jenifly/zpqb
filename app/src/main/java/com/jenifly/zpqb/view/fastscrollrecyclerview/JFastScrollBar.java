...
public class JFastScrollBar {
    ...
    /*package*/ FastScroll recyclerView;
    private JFastScrollPopup fastScrollPopup;
    ...
    public JFastScrollBar(FastScroll rv, AttributeSet attrs) {
        ...
        ta.recycle();
        recyclerView = rv;
        fastScrollPopup = new JFastScrollPopup(rv, attrs);
    ...
    public JFastScrollPopup getFastScrollPopup() {
    ...
    protected void handleTouchEvent(MotionEvent ev, int downX, int downY, int lastY) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!isDragging && !ignoreDragGesture && isNearThumb(downX, lastY) && Math.abs(y - downY) > config.getScaledTouchSlop()) {
