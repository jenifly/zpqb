...
public class JFastScrollPopup {
    ...
    private FastScroll recyclerView;
    ...
    public JFastScrollPopup(FastScroll rv, AttributeSet attrs) {
     ...
     */
    protected Rect updateFastScrollerBounds(FastScroll rv, int lastTouchY) {
