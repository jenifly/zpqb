package com.jenifly.zpqb.view.alphatabs;
...
import com.jenifly.zpqb.utils.DrawableUtils;
...
public class AlphaTabView extends View {
    ...
    public AlphaTabView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (iconNormal != null) {
            mIconNormal = BitmapUtils.getAlphaBitmap(iconNormal.getBitmap(),mTextColorNormal);
        }
        BitmapDrawable iconSelected = (BitmapDrawable) a.getDrawable(R.styleable.AlphaTabView_tabIconSelected);
        if (iconSelected != null) {
            mIconSelected = BitmapUtils.getAlphaBitmap(iconSelected.getBitmap(),mTextColorSelected);
        }
